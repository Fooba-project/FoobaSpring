...
function bannerWriteForm(){
	var opt = "toolbar=no, menubar=no, resizable=no, width=500, height=300";
	window.open("bannerWriteForm", "banner write", opt);	
}
</script>
<h2 class="admin_list">배너 리스트<br>
	<input type="button" class="bbtn" value="새 배너 등록" style="margin-left:700px; width:100px; height:30px" onclick="bannerWriteForm()">
</h2>  
